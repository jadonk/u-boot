...
const struct pad_conf_entry core_padconf_array_essential_bbai[] = {
	//{GPMC_AD0, (M2 | PIN_INPUT | MANUAL_MODE)},		/* SYSBOOT0: gpmc_ad0.vin3a_d0 */
	//{GPMC_AD1, (M2 | PIN_INPUT | MANUAL_MODE)},		/* SYSBOOT1: gpmc_ad1.vin3a_d1 */
	//{GPMC_AD2, (M2 | PIN_INPUT | MANUAL_MODE)},		/* SYSBOOT2: gpmc_ad2.vin3a_d2 */
	//{GPMC_AD3, (M2 | PIN_INPUT | MANUAL_MODE)},		/* SYSBOOT3: gpmc_ad3.vin3a_d3 */
	//{GPMC_AD4, (M2 | PIN_INPUT | MANUAL_MODE)},		/* SYSBOOT4: gpmc_ad4.vin3a_d4 */
	//{GPMC_AD5, (M2 | PIN_INPUT | MANUAL_MODE)},		/* SYSBOOT5: gpmc_ad5.vin3a_d5 */
	//{GPMC_AD6, (M2 | PIN_INPUT | MANUAL_MODE)},		/* SYSBOOT6: gpmc_ad6.vin3a_d6 */
	//{GPMC_AD7, (M2 | PIN_INPUT | MANUAL_MODE)},		/* SYSBOOT7: gpmc_ad7.vin3a_d7 */
	//{GPMC_AD8, (M2 | PIN_INPUT | MANUAL_MODE)},		/* SYSBOOT8: gpmc_ad8.vin3a_d8 */
	//{GPMC_AD9, (M2 | PIN_INPUT | MANUAL_MODE)},		/* SYSBOOT9: gpmc_ad9.vin3a_d9 */
	//{GPMC_AD10, (M2 | PIN_INPUT | MANUAL_MODE)},		/* SYSBOOT10: gpmc_ad10.vin3a_d10 */
	//{GPMC_AD11, (M2 | PIN_INPUT | MANUAL_MODE)},		/* SYSBOOT11: gpmc_ad11.vin3a_d11 */
	//{GPMC_AD12, (M2 | PIN_INPUT | MANUAL_MODE)},		/* SYSBOOT12: gpmc_ad12.vin3a_d12 */
	//{GPMC_AD13, (M2 | PIN_INPUT | MANUAL_MODE)},		/* SYSBOOT13: gpmc_ad13.vin3a_d13 */
	//{GPMC_AD14, (M2 | PIN_INPUT | MANUAL_MODE)},		/* SYSBOOT14: gpmc_ad14.vin3a_d14 */
	//{GPMC_AD15, (M2 | PIN_INPUT | MANUAL_MODE)},		/* SYSBOOT15: gpmc_ad15.vin3a_d15 */
	...
	//							/* T6 unused: gpmc_a2 */
	//{GPMC_A3, (M2 | PIN_INPUT_PULLDOWN | MANUAL_MODE)},	/* T7 unused: gpmc_a3.vin3a_d19 */
	...
	//{GPMC_A8, (M2 | PIN_INPUT_PULLDOWN | MANUAL_MODE)},	/* N7 unused: gpmc_a8.vin3a_hsync0 */
	//{GPMC_A9, (M2 | PIN_INPUT_PULLDOWN | MANUAL_MODE)},	/* R4 unused: gpmc_a9.vin3a_vsync0 */
	//{GPMC_A10, (M2 | PIN_INPUT_PULLDOWN | MANUAL_MODE)},	/* N9 unused: gpmc_a10.vin3a_de0 */
	//{GPMC_A11, (M2 | PIN_INPUT_PULLDOWN | MANUAL_MODE)},	/* P9 unused: gpmc_a11.vin3a_fld0 */
	//{GPMC_A12, (M14 | PIN_INPUT_PULLUP)},			/* P4 unused: gpmc_a12.gpio2_2 */
	//{GPMC_A13, (M14 | PIN_INPUT_PULLDOWN)},		/* R3 unused: gpmc_a13.gpio2_3 */
	//{GPMC_A14, (M14 | PIN_INPUT_PULLUP)},			/* T2 unused: gpmc_a14.gpio2_4 */
	//{GPMC_A15, (M14 | PIN_INPUT_PULLDOWN)},		/* U2 unused: gpmc_a15.gpio2_5 */
	//{GPMC_A16, (M14 | PIN_INPUT_PULLDOWN)},		/* U1 unused: gpmc_a16.gpio2_6 */
	//{GPMC_A17, (M14 | PIN_INPUT_PULLDOWN)},		/* P3 unused: gpmc_a17.gpio2_7 */
	//{GPMC_A18, (M14 | PIN_INPUT_PULLUP)},			/* R2 unused: gpmc_a18.gpio2_8 */
	...
	//{GPMC_CS0, (M14 | PIN_INPUT_PULLDOWN)},		/* T1 unused: gpmc_cs0.gpio2_19 */
	//{GPMC_CS2, (M14 | PIN_INPUT_PULLUP)},			/* P2 unused: gpmc_cs2.gpio2_20 */
	//{GPMC_CS3, (M2 | PIN_INPUT_PULLDOWN | MANUAL_MODE)},	/* P1 unused: gpmc_cs3.vin3a_clk0 */
	//{GPMC_CLK, (M9 | PIN_INPUT_PULLDOWN)},		/* P7 unused: gpmc_clk.dma_evt1 */
	{GPMC_ADVN_ALE, (M14 | PIN_INPUT_PULLUP)},		/* N1 RGMII_RST: gpmc_advn_ale.gpio2_23 */
	//{GPMC_OEN_REN, (M14 | PIN_INPUT_PULLUP)},		/* M5 unused: gpmc_oen_ren.gpio2_24 */
	//{GPMC_WEN, (M14 | PIN_INPUT_PULLUP)},			/* M3 unused: gpmc_wen.gpio2_25 */
	//{GPMC_BEN0, (M9 | PIN_INPUT_PULLDOWN)},		/* N6 unused: gpmc_ben0.dma_evt3 */
	//{GPMC_BEN1, (M9 | PIN_INPUT_PULLDOWN)},		/* M4 unused: gpmc_ben1.dma_evt4 */
	//{GPMC_WAIT0, (M14 | PIN_INPUT_PULLUP | SLEWCONTROL)},	/* N2 unused: gpmc_wait0.gpio2_28 */

	{VIN1A_CLK0, (M14 | PIN_INPUT_PULLUP)},			/* AG8 INT_ADC: vin1a_clk0.gpio2_30 */
	//{VIN1B_CLK1, (M14 | PIN_INPUT_SLEW)},			/* AH7: vin1b_clk1.gpio2_31 */
	...
	//					,		/* AE9 unused: vin1a_hsync0 */
	{VIN1A_VSYNC0, (M14 | PIN_INPUT_PULLDOWN)},		/* P9_21A: AF8_TIMER13: vin1a_vsync0.gpio3_3 */

	//							/* AE8: unused: vin1a_d0 */
	//							/* AD8: unused: vin1a_d1 */
	//{VIN1A_D2, (M14 | PIN_INPUT_PULLDOWN)},		/* AG7: unused: vin1a_d2.gpio3_6 */

	{VIN1A_D3, (M14 | PIN_INPUT_PULLDOWN)},			/* AH6 USR4: vin1a_d3.gpio3_7 */

	//{VIN1A_D4, (M14 | PIN_INPUT_PULLDOWN)},		/* AH3 unused: vin1a_d4.gpio3_8 */
	//{VIN1A_D5, (M14 | PIN_INPUT_PULLDOWN)},		/* AH5 unused: vin1a_d5.gpio3_9 */
	...
	//{VIN1A_D12, (M14 | PIN_INPUT_PULLDOWN)},		/* AF2 unused: vin1a_d12.gpio3_16 */
	...
	//{VIN1A_D22, (M14 | PIN_INPUT_PULLDOWN)},		/* AD2 unused: vin1a_d22.gpio3_26 */
	{VIN1A_D23, (M14 | PIN_OUTPUT_PULLDOWN)},		/* AD3 VDD_ADC_SEL: vin1a_d23.gpio3_27 */

	//{VIN2A_CLK0, (M14 | PIN_INPUT_PULLDOWN)},		/* E1 unused: vin2a_clk0.gpio3_28 */
	//{VIN2A_DE0, (M14 | PIN_INPUT_PULLDOWN)},		/* G2 unused: vin2a_de0.gpio3_29 */
	//{VIN2A_FLD0, (M14 | PIN_INPUT_PULLDOWN)},		/* H7 unused: vin2a_fld0.gpio3_30 */
	//{VIN2A_HSYNC0, (M11 | PIN_INPUT_PULLUP)},		/* G1 unused: vin2a_hsync0.pr1_uart0_cts_n */
	//{VIN2A_VSYNC0, (M11 | PIN_OUTPUT_PULLUP)},		/* P8_34B: G6_GPIO4_0: vin2a_vsync0.pr1_uart0_rts_n */
	//{VIN2A_D0, (M11 | PIN_INPUT_PULLUP)},			/* P8_36B: F2_GPIO4_1: vin2a_d0.pr1_uart0_rxd */
	//{VIN2A_D1, (M11 | PIN_OUTPUT)},			/* F3 unused: vin2a_d1.pr1_uart0_txd */
	{VIN2A_D2, (M14 | PIN_INPUT_PULLDOWN)},			/* P8_15A: D1: vin2a_d2.gpio4_3 */
	//{VIN2A_D3, (M8 | PIN_OUTPUT)},			/* E2 unused: vin2a_d3.uart10_txd */
	...
	//{VIN2A_D6, (M12 | PIN_INPUT | MANUAL_MODE)},		/* P9_41B: C1_GPIO4_7: vin2a_d5.pr1_pru1_gpi2 */
	//{VIN2A_D7, (M14 | PIN_INPUT_PULLDOWN)},		/* E4 unused: vin2a_d7.gpio4_8 */
	...
	//{VIN2A_D11, (M10 | PIN_INPUT_PULLDOWN)},		/* F6 unused: vin2a_d11.ehrpwm2_tripzone_input */
	...
	//{VIN2A_D15, (M3 | PIN_OUTPUT | MANUAL_MODE)},		/* C4 unused: vin2a_d15.rgmii1_txd2 */
	//{VIN2A_D16, (M3 | PIN_OUTPUT | MANUAL_MODE)},		/* B2 unused: vin2a_d16.rgmii1_txd1 */
	...
	//{VIN2A_D22, (M3 | PIN_INPUT | MANUAL_MODE)},		/* B5 unused: vin2a_d22.rgmii1_rxd1 */
	//{VIN2A_D23, (M3 | PIN_INPUT | MANUAL_MODE)},		/* A4 unused: vin2a_d23.rgmii1_rxd0 */
	...
	//{VOUT1_FLD, (M14 | PIN_INPUT)},			/* B11 unused: vout1_fld.gpio4_21 */
	...
	//{VOUT1_D12, (M0 | PIN_OUTPUT | SLEWCONTROL | MANUAL_MODE)},	/* P8_35A: A5_VOUT1_D12: vout1_d12.vout1_d12 */
	//{VOUT1_D13, (M0 | PIN_OUTPUT | SLEWCONTROL | MANUAL_MODE)},	/* P8_33A: C6_VOUT1_D13: vout1_d13.vout1_d13 */
	...
	//{VOUT1_D16, (M0 | PIN_OUTPUT | SLEWCONTROL | MANUAL_MODE)},	/* P8_45B: B7_GPIO8_16: vout1_d16.vout1_d16 */
	...
	//{VOUT1_D23, (M0 | PIN_OUTPUT | SLEWCONTROL | MANUAL_MODE)},	/* P8_46B: A10_GPIO8_23: vout1_d23.vout1_d23 */
	...
	//{RMII_MHZ_50_CLK, (M14 | PIN_INPUT_PULLUP)},		/* U3 unused: RMII_MHZ_50_CLK.gpio5_17 */
	...
	//{USB1_DRVVBUS, (M0 | PIN_OUTPUT | SLEWCONTROL)},	/* P9_13B (rev A2 only): AB10: usb1_drvvbus.usb1_drvvbus */
	...
	//{MCASP1_ACLKX, (M10 | PIN_INPUT_PULLUP)},		/* P9_31B: C14_MCASP1_ACLKX: mcasp1_aclkx.i2c3_sda */
	//{MCASP1_FSX, (M10 | PIN_INPUT_PULLUP | SLEWCONTROL)},	/* P9_29B: D14_MCASP1_FSX: mcasp1_fsx.i2c3_scl */
	{MCASP1_ACLKR, (M14 | PIN_INPUT_PULLDOWN)},		/* P9_12: B14_MCASP_ACLKR: mcasp1_aclkr.gpio5_0 */
	//{MCASP1_FSR, (M10 | PIN_INPUT_PULLUP)},		/* P9_27B: J14_MCASP_FSR: mcasp1_fsr.i2c4_scl */
	...
	//{MCASP1_AXR2, (M14 | PIN_INPUT_PULLDOWN)},		/* G13 unused: mcasp1_axr2.gpio5_4 */
	{MCASP1_AXR3, (M14 | PIN_INPUT_PULLDOWN)},		/* J11 USR1: mcasp1_axr3.gpio5_5 */
	//{MCASP1_AXR4, (M14 | PIN_INPUT_PULLDOWN)},		/* E12 unused: mcasp1_axr4.gpio5_6 */
	{MCASP1_AXR5, (M14 | PIN_OUTPUT_PULLUP)},		/* F13 eMMC_RSTn (missing on schematic): mcasp1_axr5.gpio5_7 */
	//{MCASP1_AXR6, (M14 | PIN_INPUT_PULLDOWN)},		/* C12 unused: mcasp1_axr6.gpio5_8 */
	//{MCASP1_AXR7, (M14 | PIN_INPUT_PULLDOWN)},		/* D12 unused: mcasp1_axr7.gpio5_9 */
	...
	//								/* A19 BT_PCM_CLK: mcasp2_aclkx */
	//								/* A18 BT_PCM_SYNC: mcasp2_fsx */
	//								/* E15 unused: mcasp2_aclkr */
	//								/* A20 unused: mcasp2_fsr */
	//								/* B15 BT_PCM_IN: mcasp2_axr0 */
	//								/* A15 BT_PCM_OUT: mcasp2_axr1 */
	//								/* C15 unused: mcasp2_axr2 */
	//								/* A16 unused: mcasp2_axr3 */
	//								/* D15 unused: mcasp2_axr4 */
	//								/* B16 unused: mcasp2_axr5 */
	//								/* B17 unused: mcasp2_axr6 */
	//								/* A17 unused: mcasp2_axr7 */
	//{MCASP3_ACLKX, (M0 | PIN_INPUT_PULLDOWN)},			/* B18 unused: mcasp3_aclkx.mcasp3_aclkx */
	//{MCASP3_FSX, (M0 | PIN_INPUT_SLEW)},				/* F15 unused: mcasp3_fsx.mcasp3_fsx */
	{MCASP3_AXR0, (M4 | PIN_INPUT | SLEWCONTROL)},			/* P9_11A: B19_UART5_RXD: mcasp3_axr0.uart5_rxd */
	//{MCASP3_AXR1, (M0 | PIN_INPUT_SLEW)},				/* P9_13A: C17_UART5_TXD: mcasp3_axr1.mcasp3_axr1 */
	//{MCASP4_ACLKX, (M3 | PIN_INPUT_PULLUP)},			/* P8_38B: C18_UART8_RXD: mcasp4_aclkx.uart8_rxd */
	//{MCASP4_FSX, (M3 | PIN_OUTPUT)},				/* P8_37B: A21_UART8_TXD: mcasp4_fsx.uart8_txd */
	//{MCASP4_AXR0, (M3 | PIN_INPUT_PULLUP)},			/* P8_31B: G16_UART8_CTSN: mcasp4_axr0.uart8_ctsn */
	//{MCASP4_AXR1, (M3 | PIN_OUTPUT_PULLUP)},			/* P8_32B: D17_UART8_RTSN: mcasp4_axr1.uart8_rtsn */
	//{MCASP5_ACLKX, (M3 | PIN_INPUT_PULLUP)},			/* AA3 unused: mcasp5_aclkx.uart9_rxd */
	//{MCASP5_FSX, (M3 | PIN_OUTPUT)},				/* AB9 unused: mcasp5_fsx.uart9_txd */
	//{MCASP5_AXR0, (M3 | PIN_INPUT_PULLUP)},			/* AB3 unused: mcasp5_axr0.uart9_ctsn */
	//{MCASP5_AXR1, (M3 | PIN_OUTPUT_PULLUP)},			/* AA4 unused: mcasp5_axr1.uart9_rtsn */
	...
	//{MMC1_SDWP, (M0 | PIN_INPUT | SLEWCONTROL)},		/*  Y9 unused: mmc1_sdwp.mmc1_sdwp */

	//{GPIO6_10, (M10 | PIN_OUTPUT_PULLDOWN)},		/* AC5 unused: gpio6_10.ehrpwm2A */
	//{GPIO6_11, (M0 | PIN_INPUT_PULLUP)},			/* AB4 unused: gpio6_11.gpio6_11 */
	...
	//{SPI1_SCLK, (M14 | PIN_INPUT_PULLDOWN)},		/* A25 unused: spi1_sclk.gpio7_7 */
	//{SPI1_D1, (M14 | PIN_INPUT_PULLDOWN)},		/* F16 unused: spi1_d1.gpio7_8 */
	//{SPI1_D0, (M14 | PIN_INPUT_PULLDOWN)},		/* B25 unused: spi1_d0.gpio7_9 */
	//{SPI1_CS0, (M14 | PIN_INPUT)},			/* A24 unused: spi1_cs0.gpio7_10 */
	...
	//{SPI1_CS3, (M6 | PIN_INPUT | SLEWCONTROL)},		/* B20 HDMI_DDC_CEC: spi1_cs3.hdmi1_cec */
	{SPI2_SCLK, (M1 | PIN_INPUT)},				/* P9_22B: A26_UART3_RXD: spi2_sclk.uart3_rxd */
	//{SPI2_D1, (M14 | PIN_INPUT_SLEW)},			/* P9_21B: B22_UART3_TXD: spi2_d1.gpio7_15 */
	...
	//{WAKEUP1, (M0 | PIN_INPUT)},			/* AC17: Wakeup1.Wakeup1 */
	//{WAKEUP2, (M0 | PIN_INPUT)},			/* AB16: Wakeup2.Wakeup2 */
